...
```{r}
#Usiung HUC_AnnualRecharge script to produce avg_recharge from PredictingPoints_AllData
...
ggplot(combined_data, aes(x = Avg_Recharge_mm, y = Location, fill = Location)) +
  ...
  theme_classic() +
  annotate("text", x = 17, y = 2.45, label = "Upper Verde", size = 4) +
  annotate("text", x = -9, y = 1.45, label = "Rillito", size = 4)+
